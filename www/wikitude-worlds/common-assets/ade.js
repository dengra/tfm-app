function printStackTrace(a) {
  var b = a && a.e ? a.e : null, c = !a || !!a.guess, d = new printStackTrace.implementation, e = d.run(b);
...
if (AR.build = AR.build || {}, !AR.build.mobile) {
  ...
  AR.build = AR.build || {}, AR.build.desktop = !0, AR = AR || {}, AR.js = AR.js || {}, AR.js.clickbuster = {}, AR.js.clickbuster.preventGhostClick = function (a, b) {
    ...
    touchstartEvent: function (a) {
      ...
      var b = a.touches[0].screenX - AR.js.clickBehavior.lastX, c = a.touches[0].screenY - AR.js.clickBehavior.lastY;
      ...
      var b = a.changedTouches[0].screenX - AR.js.clickBehavior.lastX, c = a.changedTouches[0].screenY - AR.js.clickBehavior.lastY;
      AR.js.clickBehavior.moveDistance += b * b + c * c;
      var d = a.changedTouches[0].screenX - AR.js.clickBehavior.startX, e = a.changedTouches[0].screenY - AR.js.clickBehavior.startY, f = d * d + e * e;
  ...
  AR.isDefined = function (a) {
  ...
  }, AR.__architectBuildVersion__ = 610, function () {
    var a = function (a) {
    ...
    var b = document.baseURI.substring(0, document.baseURI.indexOf("/") + 2), c = document.baseURI.substring(document.baseURI.indexOf("/") + 2);
    ...
    create: function (a, b, c, d) {
      ...
      switch (b) {
        ...
        case AR.ERROR.TYPE.DOM_ELEMENT:
          ...
          break;
        case AR.ERROR.TYPE.TYPE_OBJECT:
          e = AR.ERROR.ERROR_PREFIX + a + " is not an Object." + buildStack("<br />")
      }
    ...
    TYPE: {
      ...
      if (f && c)switch (c.type || (c = {type: c}), c.type) {
        ...
        case _PROPERTY_VALIDATOR.TYPE.UNIT_INTERVAL:
          if ((b = _PROPERTY_VALIDATOR.validate(a, b, _PROPERTY_VALIDATOR.TYPE.NUMERIC, d, e)) < 0 || b > 1)throw AR.ERROR.create(a, AR.ERROR.TYPE.RANGE, "[0, 1]");
          break;
        case _PROPERTY_VALIDATOR.TYPE.POSITIVE:
          if ((b = _PROPERTY_VALIDATOR.validate(a, b, _PROPERTY_VALIDATOR.TYPE.NUMERIC, d, e)) <= 0)throw AR.ERROR.create(a, AR.ERROR.TYPE.RANGE, "(0, infinity)");
          break;
        case _PROPERTY_VALIDATOR.TYPE.NON_NEGATIVE:
          if ((b = _PROPERTY_VALIDATOR.validate(a, b, _PROPERTY_VALIDATOR.TYPE.NUMERIC, d, e)) < 0)throw AR.ERROR.create(a, AR.ERROR.TYPE.RANGE, "[0, infinity)");
          break;
        case _PROPERTY_VALIDATOR.TYPE.POSITIVE_INT:
          if ((b = _PROPERTY_VALIDATOR.validate(a, b, _PROPERTY_VALIDATOR.TYPE.INT, d, e)) <= 0)throw AR.ERROR.create(a, AR.ERROR.TYPE.RANGE, "(0, infinity)");
          break;
        ...
        case _PROPERTY_VALIDATOR.TYPE.ARRAY:
          ...
          for (var g = 0; g < b.length; g++)if (!(b[g] instanceof c.ofType))throw AR.ERROR.create(a, AR.ERROR.TYPE.ARRAY_CONTENT);
          break;
        case _PROPERTY_VALIDATOR.TYPE.ARRAY_OR_PROPERTY:
          ...
          b = _PROPERTY_VALIDATOR.validate(a, b, {type: _PROPERTY_VALIDATOR.TYPE.ARRAY, ofType: c.ofType}, d, e);
          break;
        case _PROPERTY_VALIDATOR.TYPE.RGBA:
          ...
          b = b.toUpperCase();
          for (var i = "0123456789ABCDEF", g = 1; g < h; g++)if (i.indexOf(b.charAt(g)) < 0)throw AR.ERROR.create(a, AR.ERROR.TYPE.HEX);
          return 7 == h && (b += "FF"), b;
        ...
        case _PROPERTY_VALIDATOR.TYPE.OBJECT:
          if ("[object Object]" !== Object.prototype.toString.apply(b))throw AR.ERROR.create(a, AR.ERROR.TYPE.TYPE_OBJECT);
          break;
        default:
          throw"Invalid test"
      }
    ...
    init: function (a, b) {
      ...
      this.__defineSetter__("enabled", function (a) {
        ...
        f = _PROPERTY_VALIDATOR.validate("snapToScreen.enabledOnExitFieldOfVision", a, _PROPERTY_VALIDATOR.TYPE.BOOLEAN, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY), AR.i.callAsync({
          objectId: c.__id,
          is: "AR.i.trackable2DObjectInterface.enabledOnExitFieldOfVision",
        ...
        g && (g.removeEventListener("touchend", j), g.removeEventListener("resize", l, !1)), g = b, g.addEventListener("touchend", j, !1), g.addEventListener("resize", l, !1), l()
        ...
        return k(g)
      }), window.addEventListener("orientationchange", l, !1), window.addEventListener("resize", l, !1)
    }
  }), AR.DistanceToTargetController = PClass.create({
    init: function (a, b) {
      var c = a, d = 0, e = null;
      if (b && "object" != typeof b)throw AR.ERROR.create("distanceToTarget", AR.ERROR.TYPE.OBJECT, "distanceToTarget");
      b && (b.get, null != b.changedThreshold && (d = _PROPERTY_VALIDATOR.validate("distanceToTarget.changedThreshold", b.changedThreshold, _PROPERTY_VALIDATOR.TYPE.NUMERIC, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)), null != b.onDistanceChanged && (e = _PROPERTY_VALIDATOR.validate("distanceToTarget.onDistanceChanged", b.onDistanceChanged, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY))), this.__defineSetter__("changedThreshold", function (a) {
        d = _PROPERTY_VALIDATOR.validate("distanceToTarget.changedThreshold", a, _PROPERTY_VALIDATOR.TYPE.POSITIVE, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY), AR.i.callAsync({
          objectId: c.__id,
          is: "AR.i.trackable2DObjectInterface.setDistanceToTargetChangedThreshold",
          changedThreshold: d
        })
        ...
        e = _PROPERTY_VALIDATOR.validate("distanceToTarget.onDistanceChanged", a, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY), AR.i.callAsync({
          objectId: c.__id,
          is: "AR.i.trackable2DObjectInterface.setDistanceToTargetChangedTriggerActive",
    ...
    init: function () {
      ...
      for (var b in this)if (delete this[b], void 0 != this[b])try {
        ...
        contextInterface.info && AR.i.callAsync({is: "AR.i.contextInterface.info", message: "Exception caught: " + a})
      }
      this.__defineSetter__("destroyed", function (a) {
        throw AR.ERROR.create("destroyed", AR.ERROR.TYPE.IMMUTABLE)
      }), this.__defineGetter__("destroyed", function () {
    ...
    init: function (a, b) {
      var c = new Array, d = new Array, e = new Array, f = new Array;
      null != b && (b.cam && (c = _PROPERTY_VALIDATOR.validate("drawables.cam", b.cam, {
        ...
        c = g(c, b, d, AR.Drawable), AR.i.callAsync({
          objectId: a.__id,
          camDrawableIds: AR.__toJSONString__(AR.om.__getIds__(c)),
          is: "AR.i.arObjectInterface.setCamDrawables"
        })
      }, this.removeCamDrawable = function (b) {
        c = h(c, b, AR.Drawable), AR.i.callAsync({
          objectId: a.__id,
          camDrawableIds: AR.__toJSONString__(AR.om.__getIds__(c)),
          is: "AR.i.arObjectInterface.setCamDrawables"
        })
      }, this.addRadarDrawable = function (b, c) {
        a instanceof AR.GeoObject && (d = g(d, b, c, AR.Drawable2D), AR.i.callAsync({
          objectId: a.__id,
          radarDrawableIds: AR.__toJSONString__(AR.om.__getIds__(d)),
          is: "AR.i.geoObjectInterface.setRadarDrawables"
        }))
      }, this.removeRadarDrawable = function (b) {
        a instanceof AR.GeoObject && (d = h(d, b, AR.Drawable2D), AR.i.callAsync({
          objectId: a.__id,
          radarDrawableIds: AR.__toJSONString__(AR.om.__getIds__(d)),
          is: "AR.i.geoObjectInterface.setRadarDrawables"
        }))
      }, this.addIndicatorDrawable = function (b, c) {
        a instanceof AR.GeoObject && (e = g(e, b, c, AR.Drawable2D), AR.i.callAsync({
          objectId: a.__id,
          indicatorDrawableIds: AR.__toJSONString__(AR.om.__getIds__(e)),
          is: "AR.i.geoObjectInterface.setIndicatorDrawables"
        }))
      }, this.removeIndicatorDrawable = function (b) {
        a instanceof AR.GeoObject && (e = h(e, b, AR.Drawable2D), AR.i.callAsync({
          objectId: a.__id,
          indicatorDrawableIds: AR.__toJSONString__(AR.om.__getIds__(e)),
          is: "AR.i.geoObjectInterface.setIndicatorDrawables"
        }))
      }, this.addInitializationDrawable = function (b, c) {
        a instanceof AR.InstantTrackable && (f = g(f, b, c, AR.Drawable), AR.i.callAsync({
          objectId: a.__id,
        ...
        a instanceof AR.InstantTrackable && (f = h(f, b, AR.Drawable), AR.i.callAsync({
          objectId: a.__id,
          initializationDrawableIds: AR.__toJSONString__(AR.om.__getIds__(f)),
          is: "AR.i.intantTrackableInterface.setInitializationDrawables"
        }))
      ...
      var g = function (a, b, c, d) {
        ...
        for (var f = new Array, g = 0, e = 0; e < c; e++)f[g] = a[e], g++;
    ...
    init: function (a) {
      ...
      return a && (r = _PROPERTY_VALIDATOR.validate("enabled", a.enabled, _PROPERTY_VALIDATOR.TYPE.BOOLEAN, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY), null == r && (r = !0), s = _PROPERTY_VALIDATOR.validate("mirrored", a.mirrored, _PROPERTY_VALIDATOR.TYPE.BOOLEAN, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY), null == s && (s = !0), t = _PROPERTY_VALIDATOR.validate("rotatesToCamera", a.rotatesToCamera, _PROPERTY_VALIDATOR.TYPE.BOOLEAN, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY), null == t && (t = !0), a.triggers && (b = _PROPERTY_VALIDATOR.validate("onClick", a.triggers.onClick, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)), a.onClick && (b = _PROPERTY_VALIDATOR.validate("onClick", a.onClick, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)), a.onDragBegan && (c = _PROPERTY_VALIDATOR.validate("onDragBegan", a.onDragBegan, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)), a.onDragChanged && (d = _PROPERTY_VALIDATOR.validate("onDragChanged", a.onDragChanged, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)), a.onDragEnded && (e = _PROPERTY_VALIDATOR.validate("onDragEnded", a.onDragEnded, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)), a.onPanBegan && (f = _PROPERTY_VALIDATOR.validate("onPanBegan", a.onPanBegan, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)), a.onPanChanged && (g = _PROPERTY_VALIDATOR.validate("onPanChanged", a.onPanChanged, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)), a.onPanEnded && (h = _PROPERTY_VALIDATOR.validate("onPanEnded", a.onPanEnded, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)), a.onRotationBegan && (i = _PROPERTY_VALIDATOR.validate("onRotationBegan", a.onRotationBegan, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)), a.onRotationChanged && (j = _PROPERTY_VALIDATOR.validate("onRotationChanged", a.onRotationChanged, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)), a.onRotationEnded && (k = _PROPERTY_VALIDATOR.validate("onRotationEnded", a.onRotationEnded, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)), a.onScaleBegan && (l = _PROPERTY_VALIDATOR.validate("onScaleBegan", a.onScaleBegan, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)), a.onScaleChanged && (m = _PROPERTY_VALIDATOR.validate("onScaleChanged", a.onScaleChanged, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)), a.onScaleEnded && (n = _PROPERTY_VALIDATOR.validate("onScaleEnded", a.onScaleEnded, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY))), p = new AR.DrawableTranslate(this, a && a.translate ? a.translate : null), q = new AR.DrawableScale(this, a && a.scale ? a.scale : null), o = new AR.DrawableRotate(this, a && a.rotate ? a.rotate : null), this.__defineSetter__("enabled", function (a) {
        ...
        var b = _PROPERTY_VALIDATOR.validate("rotate", a, _PROPERTY_VALIDATOR.TYPE.OBJECT, _PROPERTY_VALIDATOR.RULE.MUST_BE_SET), c = {
        ...
        var b = _PROPERTY_VALIDATOR.validate("translate", a, _PROPERTY_VALIDATOR.TYPE.OBJECT, _PROPERTY_VALIDATOR.RULE.MUST_BE_SET), c = {
    ...
    init: function (a, b) {
      ...
      b && (b.x && (e = _PROPERTY_VALIDATOR.validate("rotate.x", b.x, _PROPERTY_VALIDATOR.TYPE.NUMERIC, _PROPERTY_VALIDATOR.RULE.MUST_BE_SET)), b.y && (f = _PROPERTY_VALIDATOR.validate("rotate.y", b.y, _PROPERTY_VALIDATOR.TYPE.NUMERIC, _PROPERTY_VALIDATOR.RULE.MUST_BE_SET)), b.z && (g = _PROPERTY_VALIDATOR.validate("rotate.z", b.z, _PROPERTY_VALIDATOR.TYPE.NUMERIC, _PROPERTY_VALIDATOR.RULE.MUST_BE_SET)), b.tilt && (b.global ? b.global.x = _PROPERTY_VALIDATOR.validate("rotate.tilt", b.tilt, _PROPERTY_VALIDATOR.TYPE.NUMERIC, _PROPERTY_VALIDATOR.RULE.MUST_BE_SET) : b.global = {x: _PROPERTY_VALIDATOR.validate("rotate.tilt", b.tilt, _PROPERTY_VALIDATOR.TYPE.NUMERIC, _PROPERTY_VALIDATOR.RULE.MUST_BE_SET)}), b.heading && (b.global ? b.global.y = _PROPERTY_VALIDATOR.validate("rotate.heading", b.heading, _PROPERTY_VALIDATOR.TYPE.NUMERIC, _PROPERTY_VALIDATOR.RULE.MUST_BE_SET) : b.global = {y: _PROPERTY_VALIDATOR.validate("rotate.heading", b.heading, _PROPERTY_VALIDATOR.TYPE.NUMERIC, _PROPERTY_VALIDATOR.RULE.MUST_BE_SET)}), b.roll && (b.global ? b.global.z = _PROPERTY_VALIDATOR.validate("rotate.roll", b.roll, _PROPERTY_VALIDATOR.TYPE.NUMERIC, _PROPERTY_VALIDATOR.RULE.MUST_BE_SET) : b.global = {z: _PROPERTY_VALIDATOR.validate("rotate.roll", b.roll, _PROPERTY_VALIDATOR.TYPE.NUMERIC, _PROPERTY_VALIDATOR.RULE.MUST_BE_SET)})), c = new AR.DrawableGlobalRotation(d, b && b.global ? b.global : null), this.setX = function (a, b) {
        ...
        c = new AR.DrawableRotate(this, a), AR.i.callAsync({
          ...
          objectId: this.__id,
          globalRotationY: c.y
        }), AR.i.callAsync({is: "AR.i.drawableInterface.setGlobalRotationZ", objectId: this.__id, globalRotationZ: c.z})
    ...
    init: function (a, b) {
      var c = a, d = 0, e = 0, f = 0;
      if (b && "object" != typeof b)throw AR.ERROR.create("rotate.global", AR.ERROR.TYPE.OBJECT, "rotate.global");
    ...
    init: function (a, b) {
      var c = a, d = 0, e = 0, f = 0;
      if (b && "object" != typeof b)throw AR.ERROR.create("translate.global", AR.ERROR.TYPE.OBJECT, "translate.global");
    ...
    init: function (a, b) {
      ...
      if (b) {
        if (isNaN(b) || (b = {
            ...
            y: b,
            z: b
          }), "object" != typeof b)throw AR.ERROR.create("scale", AR.ERROR.TYPE.OBJECT, "scale");
      ...
      this.setX = function (a, b) {
        ...
        return c.__isDirty("scale.x") ? AR.i.callSync({objectId: c.__id, is: "AR.i.drawableInterface.getScaleX"}) : d
      }), this.__defineSetter__("y", function (a) {
        this.setY(a, !0)
      }), this.__defineGetter__("y", function () {
        return c.__isDirty("scale.y") ? AR.i.callSync({objectId: c.__id, is: "AR.i.drawableInterface.getScaleY"}) : e
      }), this.__defineSetter__("z", function (a) {
        this.setZ(a, !0)
      }), this.__defineGetter__("z", function () {
        return c.__isDirty("scale.z") ? AR.i.callSync({objectId: c.__id, is: "AR.i.drawableInterface.getScaleZ"}) : f
      })
    }
    ...
    validateHorizontalAnchor: function (a) {
      ...
      if (null != c && (null != c.horizontalAnchor && (d = this.validateHorizontalAnchor(c.horizontalAnchor)), null != c.verticalAnchor && (e = this.validateVerticalAnchor(c.verticalAnchor)), null != c.opacity && (f = this.validateOpacity(c.opacity)), null != c.zOrder && (g = this.validateZOrder(c.zOrder))), c) {
        if (c.scale && !isNaN(c.scale)) {
          var h = c.scale;
          c.scale = {x: h, y: h}
        }
        c.rotation && (c.rotate ? c.rotate.z = c.rotation : c.rotate = {z: c.rotation}), c.offsetX && (c.translate ? c.translate.x = c.offsetX : c.translate = {x: c.offsetX}), c.offsetY && (c.translate ? c.translate.y = c.offsetY : c.translate = {y: c.offsetY})
      }
      var i = this._super(c);
      return this.__defineSetter__("opacity", function (a) {
        ...
        return g
      }), i.horizontalAnchor = d, i.verticalAnchor = e, i.opacity = f, i.zOrder = g, i
    ...
    init: function (a, b, c) {
      ...
      var g = this._super(AR.CONST.HORIZONTAL_ANCHOR.CENTER, AR.CONST.VERTICAL_ANCHOR.MIDDLE, c), h = AR.om.createObjectID();
      AR.i.callAsync({
        objectId: h,
      ...
      AR.om.registerObjectForID(i, this), this.__defineSetter__("__id", function (a) {
        ...
        a = this.validateHeight(a), AR.i.callAsync({is: "AR.i.labelInterface.setHeight", objectId: i, height: a}), e = a
    ...
    init: function (a, b) {
      ...
      var e = this._super(AR.CONST.HORIZONTAL_ANCHOR.CENTER, AR.CONST.VERTICAL_ANCHOR.MIDDLE, b), f = AR.om.createObjectID();
      AR.i.callAsync({
        objectId: f,
    ...
    init: function (a, b, c) {
      ...
      }, _PROPERTY_VALIDATOR.RULE.MUST_BE_SET), e = _PROPERTY_VALIDATOR.validate("height", b, _PROPERTY_VALIDATOR.TYPE.NON_NEGATIVE, _PROPERTY_VALIDATOR.RULE.MUST_BE_SET), f = this._super(AR.CONST.HORIZONTAL_ANCHOR.CENTER, AR.CONST.VERTICAL_ANCHOR.MIDDLE, c);
    ...
    init: function (a, b, c, d, e) {
      var f, g = _PROPERTY_VALIDATOR.validate("keyFrameWidth", c, _PROPERTY_VALIDATOR.TYPE.POSITIVE_INT, _PROPERTY_VALIDATOR.RULE.MUST_BE_SET), h = _PROPERTY_VALIDATOR.validate("keyFrameHeight", d, _PROPERTY_VALIDATOR.TYPE.POSITIVE_INT, _PROPERTY_VALIDATOR.RULE.MUST_BE_SET), i = 0;
      ...
      var d = this.validateKeyFrameArray(a), e = _PROPERTY_VALIDATOR.validate("duration", b, _PROPERTY_VALIDATOR.TYPE.POSITIVE_INT, _PROPERTY_VALIDATOR.RULE.MUST_BE_SET), f = 1;
      ...
      for (var b = 0; b < a.length; b++)if ("number" != typeof a[b] || Math.round(a[b]) != a[b])throw AR.ERROR.create(name, AR.ERROR.TYPE.ARRAY_CONTENT);
      return a
    }
    ...
    init: function (a, b, c) {
      this._super();
      var d = this.validateLatitude(a), e = this.validateLongitude(b), f = this.validateAltitude(c), g = AR.om.createObjectID();
      AR.i.callAsync({
        objectId: g,
    ...
    init: function (a, b, c, d) {
      ...
      var e = _PROPERTY_VALIDATOR.validate("location", a, {
        type: _PROPERTY_VALIDATOR.TYPE.CLASS,
        ofType: AR.Location
      }, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY), f = _PROPERTY_VALIDATOR.validate("northing", b, _PROPERTY_VALIDATOR.TYPE.NUMERIC, _PROPERTY_VALIDATOR.RULE.MUST_BE_SET), g = _PROPERTY_VALIDATOR.validate("easting", c, _PROPERTY_VALIDATOR.TYPE.NUMERIC, _PROPERTY_VALIDATOR.RULE.MUST_BE_SET), h = _PROPERTY_VALIDATOR.validate("altitudeDelta", d, _PROPERTY_VALIDATOR.TYPE.NUMERIC, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY);
      h || (h = 0);
      ...
      e ? AR.i.callAsync({
        ...
        a = _PROPERTY_VALIDATOR.validate("location", a, {
          ...
          objectId: i,
          locationId: a.__id
        }) : AR.i.callAsync({is: "AR.i.relativeLocationInterface.setLocationRelativeToUser", objectId: i}), e = a
    ...
    init: function (a, b) {
      ...
      if (a instanceof AR.Location) a = new Array(a); else if (!AR.VALIDATE.isArrayOf(a, AR.Location))throw AR.ERROR.create("locations", AR.ERROR.TYPE.ARRAY_CONTENT);
      return a
    }
    ...
    init: function (a, b, c) {
      var d = this.validateRadius(b), e = this.validateLocation(a), f = this._super(c), g = AR.om.createObjectID();
      AR.i.callAsync({
        objectId: g,
        ...
        return this.__isDirty("radius") ? AR.i.callSync({objectId: g, is: "AR.i.actionRangeInterface.getRadius"}) : d
      }), this.__defineSetter__("location", function (a) {
    ...
    init: function (a, b, c) {
      var d = this._super(c), e = _PROPERTY_VALIDATOR.validate("model", a, {
        type: _PROPERTY_VALIDATOR.TYPE.CLASS,
        ofType: AR.Model
      }, _PROPERTY_VALIDATOR.RULE.MUST_BE_SET), f = _PROPERTY_VALIDATOR.validate("animationId", b, _PROPERTY_VALIDATOR.TYPE.STRING, _PROPERTY_VALIDATOR.RULE.MUST_BE_SET), g = -1;
    ...
    init: function (a, b, c, d, e, f, g) {
      ...
      if ((null == k[l[l.length - 1]] || "number" != typeof k[l[l.length - 1]]) && "scale" != j)throw AR.ERROR.ERROR_PREFIX + "Property " + j + " is not animateable.";
      var n = _PROPERTY_VALIDATOR.validate("start", c, _PROPERTY_VALIDATOR.TYPE.NUMERIC, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY);
      null != n && void 0 != n && (n = "[" + n + "]");
      var o = "[" + _PROPERTY_VALIDATOR.validate("end", d, _PROPERTY_VALIDATOR.TYPE.NUMERIC, _PROPERTY_VALIDATOR.RULE.MUST_BE_SET) + "]", p = _PROPERTY_VALIDATOR.validate("duration", e, _PROPERTY_VALIDATOR.TYPE.NON_NEGATIVE, _PROPERTY_VALIDATOR.RULE.MUST_BE_SET);
    ...
    init: function (a, b) {
      ...
      if (void 0 === a) a = 1; else if (!AR.VALIDATE.isWholeNumber(a))throw AR.ERROR.create("loopTimes", AR.ERROR.TYPE.INT);
    ...
    validateHex: function (a, b) {
      ...
      var c = a, d = "#00000000", e = "#000000FF", f = 0, g = "#FFFFFF00", h = AR.CONST.FONT_STYLE.NORMAL, i = "#000000FF";
    ...
    CLOUD_RECOGNITION_SERVER_REGION: {AMERICAS: 1, CHINA: 2, EUROPE: 3}
    ...
    validateFunction: function (a, b) {
      ...
      _destroyAll = function () {
        ...
        throw AR.ERROR.create("cloudRecognitionServerRegionOnSuccess", AR.ERROR.TYPE.IMMUTABLE)
        ...
        throw AR.ERROR.create("cloudRecognitionServerRegionOnError", AR.ERROR.TYPE.IMMUTABLE)
        ...
        throw AR.ERROR.create("versionNumber", AR.ERROR.TYPE.IMMUTABLE)
      ...
      if (!AR.VALIDATE.isEnumerated(a, AR.CONST.CLOUD_RECOGNITION_SERVER_REGION))throw AR.ERROR.create("region", AR.ERROR.TYPE.ENUMERATION);
      b = b || {};
    ...
    validateFunction: function (a, b) {
      ...
      var a = function () {
        _enabled = !0, _flashlight = !1, _zoom = 1, _position = AR.CONST.CAMERA_POSITION.BACK, _focusMode = AR.CONST.CAMERA_FOCUS_MODE.CONTINUOUS, _manualFocusDistance = 0, this.__defineGetter__("enabled", function () {
          return _enabled
        }), this.__defineSetter__("enabled", function (a) {
          a = _PROPERTY_VALIDATOR.validate("camera.enabled", a, _PROPERTY_VALIDATOR.TYPE.BOOLEAN, _PROPERTY_VALIDATOR.RULE.MUST_BE_SET), _enabled = a, AR.i.callAsync({
          ...
          a = _PROPERTY_VALIDATOR.validate("camera.flashlight", a, _PROPERTY_VALIDATOR.TYPE.BOOLEAN, _PROPERTY_VALIDATOR.RULE.MUST_BE_SET), _flashlight = a, AR.i.callAsync({
          ...
          throw AR.ERROR.create("flashlightAvailable", AR.ERROR.TYPE.IMMUTABLE)
        }), validatePosition = function (a) {
          if (!AR.VALIDATE.isEnumerated(a, AR.CONST.CAMERA_POSITION))throw AR.ERROR.create("position", AR.ERROR.TYPE.ENUMERATION, "AR.CONST.CAMERA_POSITION.___");
          return a
        }, this.__defineGetter__("position", function () {
          return AR.i.callSync({is: "AR.i.hardwareInterface.camera_getCameraPosition"})
        }), this.__defineSetter__("position", function (a) {
          _position = validatePosition(a), AR.i.callAsync({
          ...
          a = _PROPERTY_VALIDATOR.validate("zoom", a, _PROPERTY_VALIDATOR.TYPE.POSITIVE, _PROPERTY_VALIDATOR.RULE.MUST_BE_SET), _zoom = a, AR.i.callAsync({
            is: "AR.i.hardwareInterface.camera_setCameraZoomLevel",
            level: a
          })
        }), validateFocusMode = function (a) {
          if (!AR.VALIDATE.isEnumerated(a, AR.CONST.CAMERA_FOCUS_MODE))throw AR.ERROR.create("focusMode", AR.ERROR.TYPE.ENUMERATION, "AR.CONST.CAMERA_FOCUS_MODE.___");
          return a
        }, this.__defineGetter__("focusMode", function () {
          return _focusMode
        }), this.__defineSetter__("focusMode", function (a) {
          _focusMode = validateFocusMode(a), AR.i.callAsync({
          ...
          throw AR.ERROR.create("manualFocusAvailable", AR.ERROR.TYPE.IMMUTABLE)
          ...
          a = _PROPERTY_VALIDATOR.validate("manualFocusDistance", a, _PROPERTY_VALIDATOR.TYPE.POSITIVE, _PROPERTY_VALIDATOR.RULE.MUST_BE_SET, function (a, b) {
            if (b > 100)throw AR.ERROR.create(a, AR.ERROR.TYPE.RANGE, "(0, 100)");
            return b
          }), _manualFocusDistance = a, AR.i.callAsync({
          ...
          throw AR.ERROR.create("features", AR.ERROR.TYPE.IMMUTABLE)
        })
      }, b = function () {
    ...
    var f = function (a) {
      c && (b.push(a), e.indexOf(a.type) != -1 && c.appendLine(a.toString(d), a.color))
    }, g = function () {
      if (c) {
        c.clearConsole();
        for (var a = b.length, f = 0; f < a; f++)e.indexOf(b[f].type) != -1 && c.appendLine(b[f].toString(d), b[f].color)
      }
    };
    ...
    init: function () {
      var a, b, c, d = null, e = !1, f = .5, g = .5, h = .5, i = new AR._NorthIndicator;
      this.__defineSetter__("enabled", function (a) {
        ...
        if (d) {
          var a = d.getBoundingClientRect(), b = window.innerWidth || document.documentElement.clientWidth || document.body.clientWidth, c = window.innerHeight || document.documentElement.clientHeight || document.body.clientHeight, e = a.left / b, f = a.right / b, g = a.top / c, h = a.bottom / c;
          AR.i.callAsync({is: "AR.i.a.radarInterface.setBoundingBox", left: e, right: f, top: g, bottom: h})
        }
    ...
    init: function (a, b, c) {
      var d, e, f, g, h = _PROPERTY_VALIDATOR.validate("height", b, _PROPERTY_VALIDATOR.TYPE.NON_NEGATIVE, _PROPERTY_VALIDATOR.RULE.MUST_BE_SET), i = this.validateUri(a), j = !1;
      ...
      AR.i.callAsync({is: "AR.i.videoDrawableInterface.play", objectId: this.__id, loopTimes: a ? a : 1})
    }, pause: function () {
    ...
    init: function (a, b) {
      b = b || {};
      var c, d, e = this._super(b), f = AR.om.createObjectID(), g = new AR.ScreenSnapper(this, b.snapToScreen ? b.snapToScreen : null);
      ...
      AR.i.callAsync({
        ...
        throw AR.ERROR.create("name", AR.ERROR.TYPE.IMMUTABLE)
    ...
    init: function (a) {
      ...
      a && (null != a.enabled && (f = _PROPERTY_VALIDATOR.validate("enabled", a.enabled, _PROPERTY_VALIDATOR.TYPE.BOOLEAN, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)), a.onError && (b = _PROPERTY_VALIDATOR.validate("onError", a.onError, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)), a.onDisabled && (c = _PROPERTY_VALIDATOR.validate("onDisabled", a.onDisabled, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)), a.onChangedState && (d = _PROPERTY_VALIDATOR.validate("onChangedState", a.onChangedState, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)), a.deviceHeight && (g = _PROPERTY_VALIDATOR.validate("deviceHeight", a.deviceHeight, _PROPERTY_VALIDATOR.TYPE.FLOAT, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY))), e = AR.om.createObjectID(), AR.i.callAsync({
        ...
        a = _PROPERTY_VALIDATOR.validate("state", a, _PROPERTY_VALIDATOR.TYPE.INTEGER, _PROPERTY_VALIDATOR.RULE.MUST_BE_SET), AR.i.callAsync({
          objectId: e,
        ...
        a = _PROPERTY_VALIDATOR.validate("deviceHeight", a, _PROPERTY_VALIDATOR.TYPE.FLOAT, _PROPERTY_VALIDATOR.RULE.MUST_BE_SET), g = a, AR.i.callAsync({
          objectId: e,
    ...
    init: function (a, b) {
      ...
      }, _PROPERTY_VALIDATOR.RULE.MUST_BE_SET), k = new AR.ScreenSnapper(this, b.snapToScreen ? b.snapToScreen : null);
      b.onTrackingPlaneClick && (c = _PROPERTY_VALIDATOR.validate("onTrackingPlaneClick", b.onTrackingPlaneClick, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)), b.onTrackingPlaneClick && (d = _PROPERTY_VALIDATOR.validate("onTrackingPlaneDragBegan", b.onTrackingPlaneDragBegan, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)), b.onTrackingPlaneClick && (e = _PROPERTY_VALIDATOR.validate("onTrackingPlaneDragChanged", b.onTrackingPlaneDragChanged, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)), b.onTrackingPlaneClick && (f = _PROPERTY_VALIDATOR.validate("onTrackingPlaneDragEnded", b.onTrackingPlaneDragEnded, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)), b.onTrackingStarted && (g = _PROPERTY_VALIDATOR.validate("onTrackingStarted", b.onTrackingStarted, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)), b.onTrackingStopped && (h = _PROPERTY_VALIDATOR.validate("onTrackingStopped", b.onTrackingStopped, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY));
  ...
  }), AR.platform = new AR.OneTimeUseContextConstructionPlanPlatform, AR.HtmlDrawable = AR.Drawable2D.extend({
    init: function (a, b, c) {
      var d = function (a) {
        return a.indexOf("<body") == -1 ? "<html><head/><body style='background:transparent;margin:0;'>" + a + "</body></html>" : a
      }, e = null, f = null, g = "#00000000", h = null, i = null, j = 256, k = 256, l = 1024, m = !1, n = !1, o = null;
      ...
      if (c) {
        if (c.onLoaded && (h = _PROPERTY_VALIDATOR.validate("onLoaded", c.onLoaded, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)), c.onError && (i = _PROPERTY_VALIDATOR.validate("onError", c.onError, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)), c.viewportWidth && (j = _PROPERTY_VALIDATOR.validate("viewportWidth", c.viewportWidth, _PROPERTY_VALIDATOR.TYPE.POSITIVE_INT, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)) > l)throw AR.ERROR.create("viewportWidth", AR.ERROR.TYPE.RANGE, "(0, " + l + "]");
        if (c.viewportHeight && (k = _PROPERTY_VALIDATOR.validate("viewportHeight", c.viewportHeight, _PROPERTY_VALIDATOR.TYPE.POSITIVE_INT, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)) > l)throw AR.ERROR.create("viewportHeight", AR.ERROR.TYPE.RANGE, "(0, " + l + "]");
      ...
      var q = this._super(AR.CONST.HORIZONTAL_ANCHOR.CENTER, AR.CONST.VERTICAL_ANCHOR.MIDDLE, c), r = AR.om.createObjectID();
      AR.i.callAsync({
        objectId: r,
      ...
      AR.om.registerObjectForID(s, this), this.__defineSetter__("__id", function (a) {
        ...
        return this.__isDirty("width") ? AR.i.callSync({is: "AR.i.htmlDrawableInterface.getWidth", objectId: s}) : p
      }), this.__defineSetter__("viewportWidth", function (a) {
        if ((a = _PROPERTY_VALIDATOR.validate("viewportWidth", a, _PROPERTY_VALIDATOR.TYPE.POSITIVE_INT, _PROPERTY_VALIDATOR.RULE.MUST_BE_SET)) > l)throw AR.ERROR.create("viewportWidth", AR.ERROR.TYPE.RANGE, "(0, " + l + "]");
        AR.i.callAsync({is: "AR.i.htmlDrawableInterface.setViewportWidth", objectId: s, viewportWidth: a}), j = a
      }), this.__defineGetter__("viewportWidth", function () {
        return j
      }), this.__defineSetter__("viewportHeight", function (a) {
        if ((a = _PROPERTY_VALIDATOR.validate("viewportHeight", a, _PROPERTY_VALIDATOR.TYPE.POSITIVE_INT, _PROPERTY_VALIDATOR.RULE.MUST_BE_SET)) > l)throw AR.ERROR.create("viewportHeight", AR.ERROR.TYPE.RANGE, "(0, " + l + "]");
        AR.i.callAsync({is: "AR.i.htmlDrawableInterface.setViewportHeight", objectId: s, viewportHeight: a}), k = a
    ...
    init: function (a, b) {
      if (!(a instanceof AR.TargetCollectionResource || a instanceof AR.CloudRecognitionService))throw AR.ERROR.create("trackerSource", AR.ERROR.TYPE.OBJECT, "AR.TargetCollectionResource or AR.CloudRecognitionService");
      var c, d, e, f, g, h = a.__id, i = !0;
      if (b) {
        if (null != b.enabled && (i = _PROPERTY_VALIDATOR.validate("enabled", b.enabled, _PROPERTY_VALIDATOR.TYPE.BOOLEAN, _PROPERTY_VALIDATOR.RULE.MUST_BE_SET)), null != b.physicalTargetImageHeights) {
          for (var j in b.physicalTargetImageHeights)_PROPERTY_VALIDATOR.validate("physicalTargetImageHeights", b.physicalTargetImageHeights[j], _PROPERTY_VALIDATOR.TYPE.POSITIVE_INT, _PROPERTY_VALIDATOR.RULE.MUST_BE_SET);
          c = b.physicalTargetImageHeights
        }
        b.onTargetsLoaded && (d = _PROPERTY_VALIDATOR.validate("onTargetsLoaded", b.onTargetsLoaded, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)), b.onError && (e = _PROPERTY_VALIDATOR.validate("onError", b.onError, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)), b.onDisabled && (f = _PROPERTY_VALIDATOR.validate("onDisabled", b.onDisabled, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY))
      }
      g = AR.om.createObjectID(), AR.i.callAsync({
        objectId: g,
        is: "AR.i.imageTrackerInterface.createTracker",
        sourceId: h,
        enabled: i,
        physicalTargetImageHeights: AR.__toJSONString__(c),
        onDisabledTriggerActive: null != f,
        onTargetsLoadedTriggerActive: null != d,
        ...
        return AR.i.callSync({objectId: g, is: "AR.i.imageTrackerInterface.isEnabled"})
        ...
        c = a, AR.i.callAsync({
          ...
          physicalTargetImageHeights: c
        })
      }), this.__defineGetter__("physicalTargetImageHeights", function () {
        return c
      }), this.__defineSetter__("onTargetsLoaded", function (a) {
        a = _PROPERTY_VALIDATOR.validate("onTargetsLoaded", a, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.MUST_BE_SET), d = a, AR.i.callAsync({
          objectId: g,
        ...
        a = _PROPERTY_VALIDATOR.validate("onError", a, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.MUST_BE_SET), e = a, AR.i.callAsync({
          objectId: g,
        ...
        a = _PROPERTY_VALIDATOR.validate("onDisabled", a, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.MUST_BE_SET), f = a, AR.i.callAsync({
          objectId: g,
    ...
    init: function (a, b) {
      ...
      b && (b.onProgress && (c = _PROPERTY_VALIDATOR.validate("onProgress", b.onProgress, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)), b.onLoaded && (d = _PROPERTY_VALIDATOR.validate("onLoaded", b.onLoaded, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)), b.onError && (e = _PROPERTY_VALIDATOR.validate("onError", b.onError, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY))), f = AR.om.createObjectID(), AR.i.callAsync({
        ...
        throw AR.ERROR.create("URL", AR.ERROR.TYPE.IMMUTABLE)
      }), this.__defineGetter__("URL", function () {
        return g
      }), this.__defineSetter__("loading", function () {
        throw AR.ERROR.create("loading", AR.ERROR.TYPE.IMMUTABLE)
    ...
    init: function (a, b, c) {
      var d, e, f, g, h, i, j = _PROPERTY_VALIDATOR.validate("clientToken", a, _PROPERTY_VALIDATOR.TYPE.STRING, _PROPERTY_VALIDATOR.RULE.MUST_BE_SET), k = _PROPERTY_VALIDATOR.validate("targetCollectionId", b, _PROPERTY_VALIDATOR.TYPE.STRING, _PROPERTY_VALIDATOR.RULE.MUST_BE_SET), l = [], m = 1e3;
      c && (c.onInitialized && (d = _PROPERTY_VALIDATOR.validate("onInitialized", c.onInitialized, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)), c.onError && (e = _PROPERTY_VALIDATOR.validate("onError", c.onError, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY))), f = AR.om.createObjectID(), AR.i.callAsync({
        objectId: f,
        is: "AR.i.cloudRecognitionServiceInterface.createCloudRecognitionService",
        clientToken: j,
        targetCollectionId: k,
        onInitializedTriggerActive: null != d,
        onErrorTriggerActive: null != e
      }), AR.om.registerObjectForID(f, this), this.__defineSetter__("clientToken", function () {
        throw AR.ERROR.create("clientToken", AR.ERROR.TYPE.IMMUTABLE)
      }), this.__defineGetter__("clientToken", function () {
        return j
      }), this.__defineSetter__("targetCollectionId", function () {
        throw AR.ERROR.create("targetCollectionId", AR.ERROR.TYPE.IMMUTABLE)
      }), this.__defineGetter__("targetCollectionId", function () {
        return k
      }), this.__defineSetter__("onInitialized", function (a) {
        a = _PROPERTY_VALIDATOR.validate("onInitialized", a, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY), d = a, AR.i.callAsync({
          objectId: f,
      ...
      var n = function () {
        return function () {
          AR.i.callAsync({
            ...
            objectId: f,
            onRecognizedTriggerActive: null != g,
            onRecognitionErrorTriggerActive: null != h
          })
        }
      };
      this.__startContinuousRecognitionInternally__ = function (a) {
        l.push(setInterval(n(), a))
      }, this.__stopContinuousRecognitionInternally__ = function () {
        for (; l.length;)clearInterval(l.pop())
      }, this.recognize = function (a, b) {
        g = _PROPERTY_VALIDATOR.validate("onRecognized", a, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.MUST_BE_SET), h = _PROPERTY_VALIDATOR.validate("onError", b, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY), AR.i.callAsync({
          is: "AR.i.cloudRecognitionServiceInterface.recognize",
          objectId: f,
          onRecognizedTriggerActive: null != g,
          onRecognitionErrorTriggerActive: null != h
        ...
        m = _PROPERTY_VALIDATOR.validate("interval", a, _PROPERTY_VALIDATOR.TYPE.POSITIVE_INT, _PROPERTY_VALIDATOR.RULE.MUST_BE_SET, function (a, b) {
        ...
        }), g = _PROPERTY_VALIDATOR.validate("onRecognized", c, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.MUST_BE_SET), h = _PROPERTY_VALIDATOR.validate("onRecognitionError", d, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY), i = _PROPERTY_VALIDATOR.validate("onInterruption", b, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY), this.__startContinuousRecognitionInternally__(a), AR.i.callAsync({
          is: "AR.i.cloudRecognitionServiceInterface.startContinuousRecognition",
          objectId: f,
          continuousInterval: m,
          onContinuousRecognitionInterruptionTriggerActive: null != i
        })
      }, this.stopContinuousRecognition = function () {
        this.__stopContinuousRecognitionInternally__(), AR.i.callAsync({
          is: "AR.i.cloudRecognitionServiceInterface.stopContinuousRecognition",
          objectId: f
        })
      }, this.__defineSetter__("onRecognized", function (a) {
        a = _PROPERTY_VALIDATOR.validate("onRecognized", a, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.MUST_BE_SET), g = a, AR.i.callAsync({
          objectId: f,
        ...
        a = _PROPERTY_VALIDATOR.validate("onRecognitionError", a, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.MUST_BE_SET), h = a, AR.i.callAsync({
          objectId: f,
        ...
        a = _PROPERTY_VALIDATOR.validate("onContinuousRecognitionInterruption", a, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.MUST_BE_SET), i = a, AR.i.callAsync({
          objectId: f,
    ...
    init: function (a, b, c) {
      c = c || {};
      var d, e, f = this._super(c), g = _PROPERTY_VALIDATOR.validate("tracker", a, {
        type: _PROPERTY_VALIDATOR.TYPE.CLASS,
        ofType: AR.ARchitectObject
      }, _PROPERTY_VALIDATOR.RULE.MUST_BE_SET, function (a, b) {
        if (b instanceof AR.ImageTracker || b instanceof AR.BaseTracker)return b;
        throw AR.ERROR.create(a, AR.ERROR.TYPE.OBJECT, "ImageTracker (or deprecated Cloud-/ClientTracker) ")
      }), h = _PROPERTY_VALIDATOR.validate("targetName", b, _PROPERTY_VALIDATOR.TYPE.STRING, _PROPERTY_VALIDATOR.RULE.MUST_BE_SET), i = new AR.ScreenSnapper(this, c.snapToScreen ? c.snapToScreen : null), j = new AR.DistanceToTargetController(this, c.distanceToTarget ? c.distanceToTarget : null), k = _PROPERTY_VALIDATOR.validate("enableExtendedTracking", !!c.enableExtendedTracking && c.enableExtendedTracking, _PROPERTY_VALIDATOR.TYPE.BOOLEAN, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY), l = _PROPERTY_VALIDATOR.validate("extendedTarget", null != c.extendedTarget || void 0 != c.extendedTarget ? c.extendedTarget : "*", _PROPERTY_VALIDATOR.TYPE.STRING, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY), m = _PROPERTY_VALIDATOR.validate("onExtendedTrackingQualityChanged", c.onExtendedTrackingQualityChanged ? c.onExtendedTrackingQualityChanged : null, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY);
      c.triggers && (c.triggers.onEnterFieldOfVision && (d = _PROPERTY_VALIDATOR.validate("triggers.onEnterFieldOfVision", c.triggers.onEnterFieldOfVision, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)), c.triggers.onExitFieldOfVision && (e = _PROPERTY_VALIDATOR.validate("triggers.onExitFieldOfVision", c.triggers.onExitFieldOfVision, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY))), c.onEnterFieldOfVision && (d = _PROPERTY_VALIDATOR.validate("onEnterFieldOfVision", c.onEnterFieldOfVision, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)), c.onExitFieldOfVision && (e = _PROPERTY_VALIDATOR.validate("onExitFieldOfVision", c.onExitFieldOfVision, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY));
      var n, o;
      c.onImageRecognized && (n = _PROPERTY_VALIDATOR.validate("onImageRecognized", c.onImageRecognized, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)), c.onImageLost && (o = _PROPERTY_VALIDATOR.validate("onImageLost", c.onImageLost, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY));
      var p = AR.om.createObjectID(), q = i.resolvedBoundingBox;
      AR.i.callAsync({
        objectId: p,
        ...
        targetName: b,
        enabled: f.enabled,
        onEnterFieldOfVisionTriggerActive: null != d,
        onExitFieldOfVisionTriggerActive: null != e,
        onClickTriggerActive: f.onClickTriggerActive,
        onDragBeganTriggerActive: f.onDragBeganTriggerActive,
        onDragChangedTriggerActive: f.onDragChangedTriggerActive,
        onDragEndedTriggerActive: f.onDragEndedTriggerActive,
        onPanBeganTriggerActive: f.onPanBeganTriggerActive,
        onPanChangedTriggerActive: f.onPanChangedTriggerActive,
        onPanEndedTriggerActive: f.onPanEndedTriggerActive,
        onRotationBeganTriggerActive: f.onRotationBeganTriggerActive,
        onRotationChangedTriggerActive: f.onRotationChangedTriggerActive,
        onRotationEndedTriggerActive: f.onRotationEndedTriggerActive,
        onScaleBeganTriggerActive: f.onScaleBeganTriggerActive,
        onScaleChangedTriggerActive: f.onScaleChangedTriggerActive,
        onScaleEndedTriggerActive: f.onScaleEndedTriggerActive,
        camDrawableIds: AR.__toJSONString__(AR.om.__getIds__(f.drawables.cam)),
        renderingOrder: f.renderingOrder,
        snapToScreenEnabled: i.enabled,
        screenSnapDelay: i.enableDelayed,
        snapToScreenEnabledOnExitFieldOfVision: i.enabledOnExitFieldOfVision,
        snapContainerId: q.id,
        snapPositionRight: q.right,
        snapPositionTop: q.top,
        snapPositionLeft: q.left,
        snapPositionBottom: q.bottom,
        onSnappedToScreenTriggerActive: null != i.onSnappedToScreen,
        onDelayedSnapInterruptionTriggerActive: null != i.onDelayedSnapInterruption,
        distanceToTargetChangedThreshold: j.changedThreshold,
        distanceToTargetChangedTriggerActive: null != j.onDistanceChanged,
        enableExtendedTracking: k,
        extendedTarget: l,
        onExtendedTrackingQualityChangedTriggerActive: null != m,
        onImageRecognizedTriggerActive: null != n,
        onImageLostTriggerActive: null != o
      }), AR.om.registerObjectForID(p, this), this.__defineSetter__("__id", function (a) {
        throw AR.ERROR.create("__id", AR.ERROR.TYPE.IMMUTABLE)
      }), this.__defineGetter__("__id", function () {
        return p
      }), this.__defineSetter__("tracker", function (a) {
        ...
        throw AR.ERROR.create("enableExtendedTracking", AR.ERROR.TYPE.IMMUTABLE)
      }), this.__defineGetter__("enableExtendedTracking", function () {
        return k
      }), this.__defineSetter__("extendedTarget", function (a) {
        l = _PROPERTY_VALIDATOR.validate("extendedTarget", null != a || void 0 != a ? a : "*", _PROPERTY_VALIDATOR.TYPE.STRING, _PROPERTY_VALIDATOR.RULE.MUST_BE_SET), AR.i.callAsync({
          objectId: p,
          is: "AR.i.trackable2DObjectInterface.setExtendedTarget",
          extendedTarget: l
        })
      }), this.__defineGetter__("extendedTarget", function () {
        return l
      }), this.__defineSetter__("onExtendedTrackingQualityChanged", function (a) {
        m = _PROPERTY_VALIDATOR.validate("onExtendedTrackingQualityChanged", a ? a : null, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY), AR.i.callAsync({
          objectId: p,
          is: "AR.i.trackable2DObjectInterface.setOnExtendedTrackingQualityChangedTriggerActive",
          extendedTrackingQualityChangedTriggerActive: null != m
        })
      }), this.__defineGetter__("onExtendedTrackingQualityChanged", function () {
        return m
      }), this.__defineSetter__("snapToScreen", function (a) {
        i = new AR.ScreenSnapper(this, a)
      }), this.__defineGetter__("snapToScreen", function () {
        return i
      }), this.__defineSetter__("distanceToTarget", function (a) {
        throw AR.ERROR.create("distanceToTarget", AR.ERROR.TYPE.IMMUTABLE)
        ...
        var a = AR.i.callSync({objectId: p, is: "AR.i.trackable2DObjectInterface.getAspectRatio"});
        return a < 0 ? void 0 : a
      }), this.__defineSetter__("onEnterFieldOfVision", function (a) {
        a = _PROPERTY_VALIDATOR.validate("onEnterFieldOfVision", a, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY), d = a, AR.i.callAsync({
          objectId: this.__id,
          onEnterFieldOfVisionTriggerActive: null != a,
          is: "AR.i.trackable2DObjectInterface.setOnEnterFieldOfVisionTriggerActive"
        })
      }), this.__defineGetter__("onEnterFieldOfVision", function () {
        return d
      }), this.__defineSetter__("onExitFieldOfVision", function (a) {
        a = _PROPERTY_VALIDATOR.validate("onExitFieldOfVision", a, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY), e = a, AR.i.callAsync({
          objectId: this.__id,
          onExitFieldOfVisionTriggerActive: null != a,
          is: "AR.i.trackable2DObjectInterface.setOnExitFieldOfVisionTriggerActive"
        })
      }), this.__defineGetter__("onExitFieldOfVision", function () {
        return e
      }), this.__defineSetter__("onImageRecognized", function (a) {
        a = _PROPERTY_VALIDATOR.validate("onImageRecognized", a, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY), n = a, AR.i.callAsync({
          objectId: this.__id,
          onImageRecognizedTriggerActive: null != a,
          is: "AR.i.trackable2DObjectInterface.setOnImageRecognizedTriggerActive"
        })
      }), this.__defineGetter__("onImageRecognized", function () {
        return n
      }), this.__defineSetter__("onImageLost", function (a) {
        a = _PROPERTY_VALIDATOR.validate("onImageLost", a, _PROPERTY_VALIDATOR.TYPE.FUNCTION, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY), o = a, AR.i.callAsync({
          objectId: this.__id,
          onImageLostTriggerActive: null != a,
          is: "AR.i.trackable2DObjectInterface.setOnImageLostTriggerActive"
        })
      }), this.__defineGetter__("onImageLost", function () {
        return o
      })
    }, stopExtendedTracking: function () {
      AR.i.callAsync({objectId: this.__id, is: "AR.i.trackable2DObjectInterface.stopExtendedTracking"})
    }
    ...
    init: function (a, b, c) {
      ...
      this.__defineSetter__("token", function (a) {
        throw AR.ERROR.create("token", AR.ERROR.TYPE.IMMUTABLE)
        ...
        throw AR.ERROR.create("onRecognized", AR.ERROR.TYPE.IMMUTABLE)
      }), this.__defineGetter__("onRecognized", function () {
        return this._cloudRecognitionService.onRecognized
      }), this.__defineSetter__("onRecognitionError", function (a) {
        throw AR.ERROR.create("onRecognitionError", AR.ERROR.TYPE.IMMUTABLE)
      }), this.__defineGetter__("onRecognitionError", function () {
    ...
    run: function (a) {
      ...
      var b, c, d, e = a.stacktrace, f = e.split("\n"), g = "{anonymous}", h = /.*line (\d+), column (\d+) in ((<anonymous function\:?\s*(\S+))|([^\(]+)\([^\)]*\))(?: in )?(.*)\s*$/i;
      ...
      var b, c, d, e = a.message.split("\n"), f = "{anonymous}", g = /Line\s+(\d+).*script\s+(http\S+)(?:.*in\s+function\s+(\S+))?/i;
  ...
  var __ARCHITECT_LOGGER_FRAMEWORK__ = new function () {
    ...
    this.__toggleLogLevel__ = function (a) {
      e[a][0] = !e[a][0], AR.logger.changeLogLevelEnabled(a, e[a][0]), f(a)
    };
    var f = function (a) {
      var b = d[a];
    ...
    this.activateDebugMode = function () {
      b = g(), c = h(), a = i(), a.appendChild(b), a.appendChild(c), AR.logger.registerRegistrar(c, c.canHandleColorCodes), AR.logger.changeLogLevelEnabled("ERROR", !0), AR.logger.changeLogLevelEnabled("WARNING", !0), f("ERROR"), f("WARNING"), f("INFO"), f("DEBUG");
    ...
    var g = function (a) {
      ...
      var e = document.createElement("tr"), f = document.createElement("td"), g = document.createElement("td"), h = document.createElement("td");
  ...
  AR.ADE = AR.ADE || {}, AR.ADE.Screen = function () {
    ...
    var b = function () {
      ...
      for (var j = document.createElement("table"), k = ["Latitude", "Longitude", "Altitude"], l = 0; l < 3; l++) {
        var m = document.createElement("tr"), n = document.createElement("td"), o = document.createTextNode(k[l]), p = document.createElement("td"), q = document.createElement("input");
      ...
      var u = function () {
        var a = parseFloat(document.getElementById("currentLatitude").value), b = parseFloat(document.getElementById("currentLongitude").value), c = parseFloat(document.getElementById("currentAltitude").value);
  ...
  AR.ADE = AR.ADE || {}, AR.ADE.Tree = function (a) {
    ...
    var c = function (a, b) {
      ...
      var g = [];
      if (e.value) {
        var i = AR.i.getBridgeObject(e.value).explain(), j = {
          id: e.value,
    ...
    explain: function () {
      return {
        ...
        properties: {
          ...
          onScreenClick: {type: "trigger", active: this._onScreenClickTriggerActive, trigger: "onScreenClick"},
          onDragBegan: {type: "trigger", active: this._onDragBeganTriggerActive, trigger: "onDragBegan"},
          onDragChanged: {type: "trigger", active: this._onDragChangedTriggerActive, trigger: "onDragChanged"},
          ...
          onRotationBegan: {type: "trigger", active: this._onRotationBeganTriggerActive, trigger: "onRotationBegan"},
          onRotationChanged: {
            type: "trigger",
            active: this._onRotationChangedTriggerActive,
            trigger: "onRotationChanged"
          },
          onRotationEnded: {type: "trigger", active: this._onRotationEndedTriggerActive, trigger: "onRotationEnded"},
          onScaleBegan: {type: "trigger", active: this._onScaleBeganTriggerActive, trigger: "onScaleBegan"},
          onScaleChanged: {type: "trigger", active: this._onScaleChangedTriggerActive, trigger: "onScaleChanged"},
        ...
        explain: function () {
          return {
            ...
            properties: {
              ...
              Resume: {type: "bridgecall", interfaceObject: "AR.i.soundInterface", functionName: "resume"},
    ...
    distanceTo: function (a) {
      var b = AR.i.getBridgeObject(a.objectId), c = AR.i.getBridgeObject(a.locationId), d = b.getCurrentLocation(), e = c.getCurrentLocation(), f = d.latitude, g = e.latitude, h = d.longitude, i = e.longitude;
      ...
      var e = (b - a) * Math.PI / 180, f = (d - c) * Math.PI / 180, g = Math.sin(e / 2) * Math.sin(e / 2) + Math.cos(a * Math.PI / 180) * Math.cos(b * Math.PI / 180) * Math.sin(f / 2) * Math.sin(f / 2);
    ...
    setLocation: function (a) {
      ...
      AR.i.registerBridgeObject({
        ...
        getCurrentLocation: function () {
          var b = AR.i.getBridgeObject(a.locationId), c = b.getCurrentLocation(), d = AR.i.relativeLocationInterface.calculateNewLocation(c.latitude, c.longitude, c.altitude, a.northing, a.easting, a.altitudeDelta);
    ...
    createPropertyAnimation: function (a) {
      ...
      var g = d[e[e.length - 1]], h = AR.__fromJSONString__(b._end)[0], i = 100 * (h - g) / b._duration, j = function () {
        b.runningId && (d[e[e.length - 1]] += i)
      }, k = function () {
        ...
        explain: function () {
          return {
            ...
            properties: {
              ...
              onError: {type: "trigger", active: this._onErrorTriggerActive, trigger: "onError"},
              Load: {type: "bridgecall", interfaceObject: "AR.i.imageResourceInterface", functionName: "startLoading"},
              "loaded (artificial property)": this._loaded
            }
          }
        }
        ...
        explain: function () {
          return {
            ...
            properties: {
              ...
              onLoaded: {type: "trigger", active: this._onLoadedTriggerActive, trigger: "onLoaded"},
              onError: {type: "trigger", active: this._onErrorTriggerActive, trigger: "onError"},
              onInitialized: {type: "trigger", active: this._onInitializedTriggerActive, trigger: "onInitialized"},
              Load: {type: "bridgecall", interfaceObject: "AR.i.modelInterface", functionName: "startLoading"},
              "loaded (artificial property)": this._loaded,
              enabled: this._enabled,
              mirrored: this._mirrored,
              rotatesToCamera: this._rotatesToCamera,
        ...
        explain: function () {
          return {
            ...
            properties: {
              ...
              onInitialized: {type: "trigger", active: this._onInitializedTriggerActive, trigger: "onInitialized"},
              onError: {type: "trigger", active: this._onErrorTriggerActive, trigger: "onError"},
              onRecognized: {type: "trigger", active: this._onRecognizedTriggerActive, trigger: "onRecognized"},
              onRecognitionError: {
                type: "trigger",
    ...
    setOnTrackingPlaneClickTriggerActive: function (a) {
      ...
      AR.i.registerBridgeObject({
        ...
        explain: function () {
          return {
            type: "ImageTrackable (Trackable2DObject)",
            properties: {
        ...
        explain: function () {
          return {
            ...
            properties: {
              ...
              Load: {type: "bridgecall", interfaceObject: "AR.i.imageTrackerInterface", functionName: "startLoading"},
              "loaded (artificial property)": this._loaded
            }
          }
        }
        ...
        explain: function () {
          return {
            ...
            properties: {
              ...
              onImageLost: {type: "trigger", active: this._onImageLostTriggerActive, trigger: "onImageLost"},
