...
//*****************POSTER ONE END**************************//
  ...
  worldLoaded: function worldLoadedFn() {
    ...
    document.getElementById('loadingMessage').innerHTML =
      "<div" + cssDivInstructions + ">Shoot in aperture mode with your D5200 </div>" +
      "<div" + cssDivSurfer + "><img src='assets/product_d5200_transparent.png' style='max-height: 48px'/></div>";
