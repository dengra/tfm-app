var World = {
  ...
  createOverlays: function createOverlaysFn() {
    ...
    /*
     ...
     // */ /*POSTER TRACKER 1*/
    var pageOne = new AR.Trackable2DObject(this.tracker, "woman-crossword-03-old", {
      drawables: {
        cam: [overlayOne, pageOneButton, agendaWidget]
      }
    });
//*****************POSTER ONE END**************************//
     ...
     */
    var imgTwo = new AR.ImageResource("assets/caffeine.jpg");
    var overlayTwo = new AR.ImageDrawable(imgTwo, 0.5, {
      offsetX: 0,
      offsetY: -0.25
    });
    var pageTwoButton = this.createWwwButton("https://en.wikipedia.org/wiki/Coffee", 0.15, {
      offsetX: 0,
      offsetY: -0.5,
      zOrder: 1
    });
/*
    ...
    var coffeeWidget = new AR.HtmlDrawable(
      {uri: "assets/coffee.html"},
      0.8,
      {
        viewportWidth: 256,
        viewportHeight: 220,
...
*/
    ...
    /*
     this.modelCaffeine = new AR.Model("assets/caffeine.wt3", {
     ...
     */ /* POSTER TRACKER 2 */
    var pageTwo = new AR.Trackable2DObject(this.tracker, "man-01-old", {
      drawables: {
...
*/
    ...
    /*
     Similar to the first part, the image resource and the AR.ImageDrawable for the second overlay are created. The AR.Trackable2DObject for the second page uses the same tracker but with a different target name and the second overlay.
     */ /* POSTER TRACKER 2 */
    var pageTwo = new AR.Trackable2DObject(this.tracker, "crossword-poster_00", {
      drawables: {
        cam: [overlayTwo, pageTwoButton]
      }
    });//*****************POSTER THREE END**************************//
  ...
  worldLoaded: function worldLoadedFn() {
    ...
    document.getElementById('loadingMessage').innerHTML =
      "<div" + cssDivInstructions + ">Scan Target &#35;1 (woman-crossword) or &#35;2 (man-01):</div>" +
      "<div" + cssDivSurfer + "><img src='assets/Capture.PNG'></img></div>";
      "<div" + cssDivBiker + "><img src='assets/Capture2.PNG'></img></div>";
