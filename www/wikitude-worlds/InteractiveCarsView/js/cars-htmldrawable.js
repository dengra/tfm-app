var World = {
  ...
  createOverlays: function createOverlaysFn() {
     ...
     */
    this.tracker = new AR.ClientTracker("assets/cars-tracker.wtc", {
     ...
     */ /*SURFBRETT IMAGE*/
    var imgOne = new AR.ImageResource("assets/caffeine.jpg");
    ...
    /*
     ...
     // */ /*POSTER TRACKER 1*/
    var pageOne = new AR.Trackable2DObject(this.tracker, "bmw-i3", {
      drawables: {
